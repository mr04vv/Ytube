...
const Information = () => (
  <>
    ...
    <FooterContainer>
      ...
      <SNSLink target="_brank" href="https://www.youtube.com/channel/UCSkLRGGIGKOtinamhcy_42g">
        [YouTube]YY-CHANNEL [YCH]
      </SNSLink>
      <SNSLink target="_brank" href="https://twitter.com/ABCDYY">
        [Twitter]わいわい(31)
      </SNSLink>
      <SNSLink target="_brank" href="https://www.instagram.com/waiwai_31yearsold/?hl=ja">
        [Instagram]わいわい(31)
      </SNSLink>
      <Title>運営より</Title>
      <Text>
      ...
      <SNSLink
        target="_brank"
        href="https://www.amazon.co.jp/hz/wishlist/ls/J7CJ3KNEL2PF?type=wishlist&filter=unpurchased&sort=price-asc"
      >
        サイトを支援する
      </SNSLink>
      <SNSLink target="_brank" href="https://twitter.com/YTube_official">
        作者Twitterリンク
      </SNSLink>
      {/* <SNSLink target="_brank" href="https://twitter.com/akkun_jiro">作者Twitterリンク２</SNSLink> */}
      <SNSLink target="_brank" href="https://mooriii.com/">
        作者ホームページ
      </SNSLink>
      <SNSLink target="_brank" href="https://github.com/mr04vv/Ytube">
        ソースコード
      </SNSLink>
...
{' '}
      ...
      <Attention>
        ...
        なおこの規約に関しまして、詳細は
        <a target="_brank" href="https://marketingplatform.google.com/about/analytics/terms/jp/">
          Googleアナリティクス利用規約
        </a>
        にてご確認ください。
      </Attention>
