    ...
    <>
      ...
      >
        {window.windowDimensions.width > 480 ?
          posts.posts.map(post => <A width={window.windowDimensions.width} splitSize={window.splitSize}>
            <PostListItem post={post as any} />
                                  </A>)
          :
          posts.posts.map(post => <div style={{
            minWidth: '230px',
            margin: '2px 0'
          }}
          >
